...
#define TFT_BL_H()	GPIOA->BSRR |= (1<<4);//HAL_GPIO_WritePin(ST7735_BL_GPIO_Port, ST7735_BL_Pin, GPIO_PIN_SET);
#define TFT_BL_L()	GPIOA->BSRR |= (1<<20);//HAL_GPIO_WritePin(ST7735_BL_GPIO_Port, ST7735_BL_Pin, GPIO_PIN_RESET);
#define TFT_CS_H()	GPIOA->BSRR |= (1<<1);//HAL_GPIO_WritePin(ST7735_BL_GPIO_Port, ST7735_CS_Pin, GPIO_PIN_SET);
#define TFT_CS_L()	GPIOA->BSRR |= (1<<17);//HAL_GPIO_WritePin(ST7735_BL_GPIO_Port, ST7735_CS_Pin, GPIO_PIN_RESET);
#define TFT_DC_D()	GPIOB->BSRR |= (1<<2);//HAL_GPIO_WritePin(ST7735_DC_GPIO_Port, ST7735_DC_Pin, GPIO_PIN_SET);//GPIOB->BSRR |= (1<<2);//
#define TFT_DC_C()	GPIOB->BSRR |= (1<<18);//HAL_GPIO_WritePin(ST7735_DC_GPIO_Port, ST7735_DC_Pin, GPIO_PIN_RESET);//GPIOB->BSRR |= (1<<18);//
#define TFT_RES_H()	GPIOB->BSRR |= (1<<0);//HAL_GPIO_WritePin(ST7735_RES_GPIO_Port, ST7735_RES_Pin, GPIO_PIN_SET);
#define TFT_RES_L()	GPIOB->BSRR |= (1<<16);//HAL_GPIO_WritePin(ST7735_RES_GPIO_Port, ST7735_RES_Pin, GPIO_PIN_SET);
